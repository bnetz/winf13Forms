...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <p>Wir brauchen keine Hunde und Katzen, sondern eine Klasse, die uns später bei der Formularauswertung hilft. Dafür importieren wir die Klasse <code>Formularhandler.class.php</code>. Siehe ganz oben in dieser Datei.</p>
            <p>Letztlich funktioniert das alles wie mit den Hunden und den Katzen. Was <strong>neu</strong> ist: Wir geben dieser Klasse im Konstruktor das ganze <code>$_POST</code>-Array - dann kann die das verwalten (z.B. checken, ob das Formular abgeschickt wurde, welche Felder leer sind, ob ein Feld einen bestimmten Wert enthält …).</p>
            <p>Zur Demonstration verwenden wir einige Zeilen weiter unten die Methode <code>processInput()</code>.</p>
